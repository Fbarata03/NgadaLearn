  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        {/* Back */}
        <Link to="/lessons" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-600 hover:text-pink-600 transition-colors mb-5 min-h-[44px] -ml-1 px-1">
